...
def run_style_transfer(content_path, num_content_layers, num_style_layers,
                       style_path,
                       num_iterations=1000,
                       content_weight=1e3, #1e3
...
if __name__ == "__main__":
  ...
  content_path = '/home/darg2/Downloads/cem.jpg'
  style_path = '/home/darg2/Downloads/starry_nights.jpg'
  ...
  best, best_loss = run_style_transfer(content_path, 
                                      ...
                                      content_weight=content_weight,  # default 1e3
                                      style_weight=style_weight,   # default 1e-2
                                      num_iterations=iteration) # must be divisible by 100
